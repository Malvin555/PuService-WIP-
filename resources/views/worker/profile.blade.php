...
@section('title', 'PuService | Worker Profile')
    ...
    <div >
        ...
        <div class="bg-white shadow-sm overflow-hidden sm:rounded-lg border border-gray-100 mb-10">
            ...
            <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
                <form class="space-y-6" method="POST" action="{{ route('worker.profile.update') }}">
                    @csrf
        ...
        <div class="bg-white shadow-sm overflow-hidden sm:rounded-lg border border-gray-100 mb-10">
            ...
            <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
                <form class="space-y-6" method="POST" action="{{ route('worker.password.update') }}">
                    @csrf
                    <div>
