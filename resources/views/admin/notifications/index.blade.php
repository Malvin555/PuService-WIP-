...
<div class="min-h-screen bg-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="bg-white p-6 rounded-xl shadow-md mb-12 border border-blue-100">
            ...
            <form method="POST" action="{{ route('admin.send.notification') }}" id="notificationForm" class="space-y-6">
                @csrf
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse($notifications as $notification)
                            <tr class="hover:bg-blue-50 transition">
                                ...
                                <td class="px-6 py-4">
                                    <form method="POST" action="{{ route('admin.delete.notification', $notification->id) }}"
