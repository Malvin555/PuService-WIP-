...
@section('title', 'PuService | Register')
            ...
            <div class="bg-white py-8 px-4 shadow-sm sm:rounded-lg sm:px-10 border border-gray-100">
                <form class="space-y-6" action="#" method="POST">
                    ...
                    <div>
                        ...
                        <div style="min-height: 20px; color: red;"></div>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="terms" class="ml-2 block text-sm text-gray-700">
                            ...
                            <a href="{{ route('terms') }}" target="_blank"
                                class="font-medium text-blue-600 hover:text-blue-500">Terms
                                of Service</a>
                            and
                            <a href="{{ route('privacy') }}"
                                target="_blank" class="font-medium text-blue-600 hover:text-blue-500">Privacy Policy</a>
                        </label>
                    </div>
