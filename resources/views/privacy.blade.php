...
@section('title', 'Privacy Policy - PuService')
    ...
    <section class="bg-blue-600 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
            <div class="text-center">
                <h1 class="text-3xl md:text-4xl font-bold tracking-tight">Privacy Policy</h1>
    ...
    <section class="py-12 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="prose prose-blue prose-lg max-w-none">
                <p>
                    At PuService, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the platform.
                </p>
                ...
                <ul>
                    ...
                    <li>Process and manage your reports and requests</li>
                    <li>Communicate with you about your reports, account, and our services</li>
                ...
                <ul>
                    <li>With government agencies and service providers necessary to process your reports</li>
    ...
    <section class="py-12 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow-md overflow-hidden sm:flex sm:items-center sm:justify-between p-6 sm:p-8">
                <div>
                    <h2 class="text-xl font-bold text-gray-900">Have questions about our privacy practices?</h2>
