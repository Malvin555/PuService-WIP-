    ...
    return (
        <div className="hidden md:block">
            <Card className="shadow-sm gap-0 flex flex-col overflow-hidden">
                            ...
                            {currentReports.length === 0 ? (
                                ...
                                currentReports.map((report, index) => (
                                    ...
                                    >
                                        ...
                                        <TableCell
                                            className="px-6 py-4 text-sm font-medium text-foreground max-w-[250px] truncate">
                ...
                <div
                    className="px-6 py-4 bg-muted/10 border-t flex flex-col md:flex-row md:items-center md:justify-between gap-4 flex-shrink-0">
